...
public class MosiMovement : MonoBehaviour
{
    ...
    private readonly int isWalkingHash = Animator.StringToHash("MOisWalking");
    private readonly int isTalkingHash = Animator.StringToHash("MOisTalking");
    private readonly int reactHash = Animator.StringToHash("MOisReact");
