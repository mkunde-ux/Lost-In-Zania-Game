...
public class MosiInteraction : MonoBehaviour
{
    //Check Adila interaction script for comments

    [Header("References")]
    [SerializeField] private MosiDialogue mosiDialogue;
    [SerializeField] private Canvas interactionCanvas;
    [SerializeField] private Canvas dialogueCanvas;
    [SerializeField] private MosiHeadLook npcHeadLookAt;
    ...
    [SerializeField] private MosiMovement mosiMovement;
    ...
    private void Awake()
    {
        ...
        mosiDialogue.onDialogueEnd.AddListener(OnDialogueEnd);      
    }
    ...
    {
        if (!npcHeadLookAt) npcHeadLookAt = GetComponent<MosiHeadLook>();
        Debug.Assert(npcHeadLookAt != null, "HeadLook component is missing from NPC", this);
        Debug.Assert(mosiDialogue != null, "mosiDialogue reference is missing", this);
        ...
        if (mosiMovement == null) mosiMovement = GetComponent<MosiMovement>();
        Debug.Assert(mosiMovement != null, "mosiMovement reference is missing", this);
    ...
    {        
        ...
        {
            mosiMovement.InteractWithPlayer(true);
        }
        _isEngaged = true;
        ToggleUI(true);          
        interactionCanvas.gameObject.SetActive(false);  
        ...
        mosiDialogue.enabled = true;
        mosiDialogue.ResetDialogue();
