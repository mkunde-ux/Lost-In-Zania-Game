...
public class LucaMovement : MonoBehaviour
{
    ...
    private readonly int isWalkingHash = Animator.StringToHash("LUisWalking");
    private readonly int isTalkingHash = Animator.StringToHash("LUisTalking");
    private readonly int reactHash = Animator.StringToHash("LUisReact");
