...
public class EmanuelMovement : MonoBehaviour
{
    //Check the FahariMovement Script for comments
    ...
    private readonly int isWalkingHash = Animator.StringToHash("EMisWalking");
    private readonly int isTalkingHash = Animator.StringToHash("EMisTalking");
    private readonly int reactHash = Animator.StringToHash("EMReact");
