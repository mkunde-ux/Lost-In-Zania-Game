...
public class DalilaMovement : MonoBehaviour
{
    ...
    private readonly int isWalkingHash = Animator.StringToHash("DAisWalking");
    private readonly int isTalkingHash = Animator.StringToHash("DAisTalking");
    private readonly int reactHash = Animator.StringToHash("DAReact");
