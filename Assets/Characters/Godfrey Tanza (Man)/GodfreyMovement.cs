...
public class GodfreyMovement : MonoBehaviour
{
    //Check Adila Movement script for comments
    ...
    private readonly int isWalkingHash = Animator.StringToHash("GOisWalking");
    private readonly int isTalkingHash = Animator.StringToHash("GOisTalking");
    private readonly int reactHash = Animator.StringToHash("GOisReact");
